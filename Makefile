...
CPPFLAGS = -pg -c -std=c++11 -Wall -Wextra -Wvla -pedantic -g3 -O3
#to do profiling, add -pg flag to g++ below:
logman: Main.o LogReader.o LogPrinter.o Index.o CommandReader.o TimeToNum.o
	g++ -pg Main.o LogReader.o LogPrinter.o Index.o CommandReader.o TimeToNum.o -o logman
...
testcorrect: logman
	...
	./logman correct_samples/sample-log.txt < correct_samples/sample-all-cmds.txt > correct_samples/out-all.txt
	touch testcorrect
checkcorrect:
	#python trim.py
